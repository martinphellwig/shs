...
#
""" """
# 6.6 SHA-512/256 Hash Computation (copy of SHA-512)
...
from _constants_and_initials import H0_SHA_512_256, K_SHA_512_256
...
def computation(message):
    ...
    for block in blocks:
        ...
        for index in range(80):
            ...
            kt = Bits(K_SHA_512_256[index], SIZE_WORD)
